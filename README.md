...
> Building AI agents and the infrastructure that lets them operate autonomously. Focused on agent tools, autonomous systems, and developer tooling that makes AI accessible and easy to build with and use.
...
[![GitHub Contribution Graph](https://ghchart.rshah.org/TheGreatAxios)](https://github.com/TheGreatAxios)

---

## What I'm Doing

- **Agent harnesses** — Building tools that let AI agents control browsers, APIs, and legacy systems
